...
<body class="custom_page">
    <div class="custom-container">
        <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <div class="dropdown d-flex align-items-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="{{ route('tms.warehouse.index_chuter2_All') }}">All</a>
            ...
            <div class="mt-1 text-center">
                <h3 class="ml-2 mt-0 mb-0" style="font-size: 15px"><b>ABNORMALITY Lantai 2</b></h3>
        ...
        <!-- Tombol Previous dan Next di bagian bawah carousel -->
    </div>


    <!-- Controls di bawah carousel -->
    ...
    <script>
        ...
        //     var customTable1s = document.querySelectorAll('.custom-table1');
        ...
        //             fontSize = '11px'; // Untuk 3, 4, atau 5 tabel, ukuran font sedang
        //         }
        ...
        //     customTable1s.forEach(function(table) {
        //         // Hitung jumlah tabel
        //         var tableCount = table.querySelectorAll('tr').length -
        //             1; // Menghitung jumlah baris di tabel (tidak termasuk header)

        //         var fontSize1 = '10px'; // Ukuran default jika tidak memenuhi kondisi berikut
        //         if (tableCount === 3) {
        //             fontSize1 = '9px'; // Untuk 3 tabel, ukuran font 10px
        //         } else if (tableCount === 4) {
        //             fontSize1 = '8px'; // Untuk 4 tabel, ukuran font 9px
        //         } else if (tableCount === 5) {
        //             fontSize1 = '5px'; // Untuk 5 tabel, ukuran font 8px
        //         }
        ...
        //         ths.forEach(function(th) {
        //             th.style.fontSize = fontSize1;
        //         });

        //         tds.forEach(function(td) {
        //             td.style.fontSize = fontSize1;
        //         });
        //     });
        // });
