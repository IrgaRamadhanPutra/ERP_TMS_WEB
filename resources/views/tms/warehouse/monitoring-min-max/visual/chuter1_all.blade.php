        ...
        <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <div class="dropdown d-flex align-items-center">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="{{ route('tms.warehouse.index_chuter1_abnormality') }}">Abnormality</a>
            ...
            <div class="mt-1 text-center">
                <h3 class="ml-2 mt-0 mb-0" style="font-size: 15px"><b>ALL CONDITION Lantai 1</b></h3>
                                            ...
                                            <table class="table mt-1 custom-table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center" rowspan="2"
                                                            style="vertical-align: middle;">STOCK</th>
                                                        <th class="text-center" rowspan="2"
                                                ...
                                                <tbody>
                                                    @foreach ($table['items'] as $item)
                                                        <tr>
                                                            ...
                                                            @if ($item['balance'] < $item['min']) rgba(255, 0, 0, 0.801);
                                                            @elseif($item['balance'] > $item['max']) rgba(255, 196, 0, 0.801);
                                                            @else rgba(0, 255, 42, 0.801); @endif; vertical-align: middle;">
                                                                {{ $item['balance'] }}</td>
                                                            <td rowspan="2" class="text-center"
                                                            ...
                                                            <td rowspan="2" class="text-center"
                                                            style="background-color:
                                                            @if ($item['total'] < $item['min']) rgba(255, 0, 0, 0.801);
                                                            @elseif($item['total'] > $item['max']) rgba(255, 196, 0, 0.801);
                                                            @else rgba(0, 255, 42, 0.801); @endif; vertical-align: middle;">
                                                                {{ $item['total'] }}</td>
                                                            <td rowspan="2" class="text-center"
                                ...
                                <div class="col-12 col-sm-6 col-md-4">
                                    <div class="table-responsive">
                                        <table class="table mt-1 custom-table">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" style="vertical-align: middle;">CHUTER</th>
                                                    <th class="text-center" style="vertical-align: middle;">ITEMCODE</th>
                                                    <th class="text-center" style="vertical-align: middle;">STOCK</th>
                                                    <th class="text-center" style="vertical-align: middle;">OVER FLOW</th>
                                                    <th class="text-center" style="vertical-align: middle;">TOTAL</th>
                                                    <th class="text-center" style="vertical-align: middle;">STAGING</th>
                                                </tr>
