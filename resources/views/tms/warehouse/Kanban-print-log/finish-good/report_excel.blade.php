...
<body>
    <table>
        <tr>
            <td colspan="6" style="font-size:15px;"><b>Kanban Print Log Finish Good</b></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6">Kanban No : {{ $kanbanNofg }}</td>
        </tr>
        <tr>
            <td colspan="6">Created By : {{ $createdByfg }}</td>
        </tr>
    </table>
    <br>
