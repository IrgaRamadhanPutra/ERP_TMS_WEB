<div class="modal fade bd-example-modal-xl modalViewminmax" data-backdrop="static" data-keyboard="false"
    style="z-index: 1041" tabindex="-1" id="modalViewminmax" role="dialog">
            ...
            <div class="row">
                <div class="col">
                    <div class="modal-body">
                        <form method="POST">
                            @csrf
                            @include('tms.warehouse.min-max.modal.view-min-max.form')
                            {{-- <hr> --}}
                    </div>
                    </form>
...
<script>
    $(document).on('click', '.view', function(e) {
        ...
        // alert(id);
        $('#modalViewminmax').modal('show');
        getDetail(id, 'VIEW')
    });

    function getDetail(id, method) {
        var route = "{{ route('tms.warehouse.master_min_max.show_view_masterminmax', ':id') }}";
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#stock_type_view').val(data['getView'].stock_type);
                $('#plant_view').val(data['getView'].plant);
