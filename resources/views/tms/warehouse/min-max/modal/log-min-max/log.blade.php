    ...
    <div class="modal-dialog modal-xl" style="max-width: 1000px; width: 100%">
        <div class="modal-content">
            <div class="modal-header border-bottom text-dark">
                <h4 class="modal-title"> Form Master Min Max --Log--</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="datatable datatable-primary">
                                    <table id="tblMasterminmax" class="table table-bordered table-hover" width="100%">
...
<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '.log', function(e) {
            ...
            var route = "{{ route('tms.warehouse.masterminmax_log', ':id') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#tblMasterminmax').DataTable().clear().destroy();
                    $('#tblMasterminmax').DataTable({
                        data: detailDataset,
                        columns: [{
                                data: 0
                            }, // Chutter Address
