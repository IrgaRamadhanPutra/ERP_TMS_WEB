    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title fs-5" id="importExcelcreateLabel">Import Create Min Max Chuter</h4>
            ...
            <div class="modal-body">
                <form id="importExcelForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control" type="file" id="importFile" name="importFile" accept=".xls,.xlsx">
                    </div>
                  </form>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="closeModal" data-bs-dismiss="modal"> <i class="ti-close"></i>
                    &nbsp;Close</button>
...
<script>
      $(document).ready(function() {
        ...
        $(document).on('click', '#showModalimport', function(e) {
            e.preventDefault();
            // alert('oke');
        ...
        $(document).on('click', '#btnSave', function(e) {
            ...
            if (inputFile.val() === '') {
                ...
                $.ajax({
                        type: 'POST',
                        url: "{{ route('tms.warehouse.master_min_max_chuter.import_excel_create') }}",
                        data: formData,
                        processData: false,
                        contentType: false,
                        success: function(response) {
                            ...
                            if (response.message === 'success') {
                                ...
                                $('#masterMinMaxchuter-datatables').DataTable().ajax.reload();
