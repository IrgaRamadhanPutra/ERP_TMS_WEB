<fieldset class="form">
    <div class="modal-body">
        ...
        <div class="form-group row">
            <label for="process_code_create" class="col-sm-2 col-form-label"><b>Process Code</b></label>
            <div class="col-sm-3">
                <input type="text" value="" name="process_code_create"
                    class="form-control form-control-sm uppercase-input" id="process_code_create" placeholder="">
            </div>
        </div>
        <div class="form-group row">
            <label for="supplier_create" class="col-sm-2 col-form-label"><b>Supplier</b></label>
            <div class="col-sm-3">
                <input type="text" value="" name="supplier_create"
                    class="form-control form-control-sm uppercase-input" id="supplier_create" placeholder="">
            </div>
        </div>
        <div class="form-group row">
            <label for="cust_code_create" class="col-sm-2 col-form-label"><b>Cust Code</b></label>
            <div class="col-sm-3">
                <input type="text" value="" name="cust_code_create"
                    class="form-control form-control-sm uppercase-input" id="cust_code_create" placeholder="">
            </div>
        </div>
        <div class="form-group row">
            <label for="stock_type_create" class="col-sm-2 col-form-label"><b>Stock Type</b></label>
            <div class="col-sm-3">
                <input type="text" value="R/M" name="stock_type_create"
                    class="form-control form-control-sm uppercase-input" id="stock_type_create" placeholder="" readonly>
            </div>
        </div>
        <div class="form-group row align-items-center">
            <label for="stock_type_create" class="col-sm-2 col-form-label"><b>Plant</b></label>
            <div class="col-sm-3">
