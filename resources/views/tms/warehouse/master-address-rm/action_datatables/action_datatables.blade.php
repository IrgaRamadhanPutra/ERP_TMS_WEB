    ...
    <div class="btn-group">
        ...
        <div class="dropdown-menu">
            ...
            <a href="#" style="color: rgb(88, 152, 248);" data-toggle="tooltip" row-id="{{ $model->id }}"
                data-id="{{ $model->itemcode }}" data-placement="top" title="Edit" class="dropdown-item edit">
                <i class="ti-pencil-alt"></i> Edit</a>

            <a href="#" style="color: red;" data-toggle="tooltip" row-id="{{ $model->id }}"
                data-id={{ $model->itemcode }} data-target="" data-placement="top" title="Void"
                class="dropdown-item voided"> <i class="ti-trash"></i> Void</a>
            <a href="#" data-toggle="tooltip" style="color: rgb(0, 0, 0);" row-id="{{ $model->id }}"
                data-id="{{ $model->itemcode }}" data-placement="top" title="Log" class="dropdown-item log">
                <i class="ti-share"></i> Log</a>
            <a href="#" data-toggle="tooltip" style="color: rgb(0, 0, 0);" row-id="{{ $model->id }}"
                data-itemcode="{{ $model->itemcode }}" data-chuter="{{ $model->chuter_address }}" data-placement="top"
                title="Print" class="dropdown-item print">
                <i class="fa fa-file"></i> Print</a>
        </div>
    </div>
