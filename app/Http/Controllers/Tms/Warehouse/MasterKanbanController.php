        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) { // Tambahkan kolom 'action' secara dinamis
                    return view('tms.warehouse.master-kanban.action_datatables.action_datatables', [
                        'model' => $data,
                    ]);
                })
                ->rawColumns(['action'])
    ...
    public function store_masterkanban(Request $request)
    {
        ...
        try {
            ...
            $store_param = Ekanban_param_tbl::create([
                ...
                'nextline_code' => $nextline_code,
                'line_code_pw' => $line_code_pw,
                'nextline_code_pw' => $nextline_code_pw,
